...
const BookHeart = createLucideIcon("book-heart", __iconNode$8);
const __iconNode$7 = [
...
const MessageCircleHeart = createLucideIcon("message-circle-heart", __iconNode$4);
const __iconNode$3 = [
  [
    "path",
    {
